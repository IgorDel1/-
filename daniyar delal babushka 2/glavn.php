    ...
    <main>
        ...
        <footer class="footer"> 
            <div class="container"> 
                ...
                <div class="footer-item"> 
                    <ul> 
                        <li><a href="glavn.php">Главная</a></li>
                        <li><a href="glavn.php">Регистрация</a></li> 
                        <li><a href="glavn.php">Авторизация</a></li> 
                        <li><a href="glavn.php">Личный кабинет</a></li> 
                        <li><a href="glavn.php">Найдено животное</a></li>
                        <li><a href="glavn.php">Поиск</a></li>    
                    </ul> 
                </div> 
                </div> 
