...
--
-- Хост: 127.0.0.1
-- Время создания: Дек 18 2024 г., 07:39
...
(1, 11, 'cat', 'Black and White', '123', 'Lenina, 25', '2014-12-01', 'active'),
(6, 8, 'cat', 'White and Black', '321', 'Timonova, 52', '2017-06-18', 'active'),
(7, 11, 'cat', 'negr', '777', 'Octyabyrskaya, 30', '2021-04-16', 'mod');
...
(8, 'Igor', 'Del', 'deligor02.06.2004@gmail.com', '880005553555', 'igor01', 1, NULL, 'default'),
(9, 'Egor', 'Del', 'ex@mail.ru', '89993336556', 'ed6556', 1, 'aGFzaD0xNzMzNzEwOTAxJmVtYWlsPWV4QG1haWwucnUmcGFzc3dvcmQ9ZWQ2NTU2', 'default'),
(10, 'Модератор', 'Модераторов', 'mod@mail.ru', '87776665544', 'mod5544', 1, 'aGFzaD0xNzM0NTAzMjI4JmVtYWlsPW1vZEBtYWlsLnJ1JnBhc3N3b3JkPW1vZDU1NDQ=', 'mod'),
(11, 'Данияр лох', 'Пидр', 'rc@gmail.com', '89739479089', 'dani01', 1, NULL, 'default');
